                     ...
                     int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_MYBRANCH, szWindowClass, MAX_LOADSTRING);
	...
	char *str5 = "str5 add to master";

	char *str6 = "str6 add to master";
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_MYBRANCH));
	wcex.hCursor		= LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground	= (HBRUSH)(COLOR_WINDOW+1);
	wcex.lpszMenuName	= MAKEINTRESOURCE(IDC_MYBRANCH);
